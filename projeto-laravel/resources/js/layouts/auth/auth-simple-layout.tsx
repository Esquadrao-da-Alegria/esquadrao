...
export default function AuthLayoutTemplate({
    ...
    return (
        <div className="mt-5 min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-100 via-pink-100 to-purple-100 p-6">
            <div className="relative w-full max-w-md overflow-hidden rounded-3xl bg-white dark:bg-gray-800 shadow-2xl p-8 md:p-12">
                ...
                <div className="mb-8 text-center">
                    <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white carlos@email.com e md:text-4xl">{title}</h1>
