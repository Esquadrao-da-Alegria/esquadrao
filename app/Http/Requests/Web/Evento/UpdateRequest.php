...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['required', 'string', Rule::in(['AGENDADO', 'FINALIZADO', 'CANCELADO', 'TRANSFERIDO'])],
            ...
            'criado_por_id' => ['nullable', 'integer', 'exists:users,id'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'criado_por_id.required' => 'O responsável pelo evento é obrigatório.',
            'criado_por_id.integer' => 'O responsável pelo evento deve ser um identificador válido.',
            'criado_por_id.exists' => 'O usuário responsável pelo evento não existe.',
        ];
    }
}
