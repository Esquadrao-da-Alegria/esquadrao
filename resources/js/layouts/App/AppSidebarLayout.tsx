...
const appPrimaryYellow = cn(
    ...
    'dark:[--primary:oklch(0.86_0.14_98)] dark:[--primary-foreground:oklch(0.16_0.03_98)]',
    'dark:[--sidebar-primary:oklch(0.86_0.14_98)] dark:[--sidebar-primary-foreground:oklch(0.16_0.03_98)]',
    'dark:[--ring:oklch(0.68_0.14_98)] dark:[--sidebar-ring:oklch(0.68_0.14_98)]',
    'dark:[--sidebar-accent:oklch(0.3_0.07_98)] dark:[--sidebar-accent-foreground:oklch(0.96_0.04_98)]',
);
