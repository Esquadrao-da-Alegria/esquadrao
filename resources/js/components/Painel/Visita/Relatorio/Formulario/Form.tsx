        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <select
                    ...
                    onChange={(e) => onFieldChange('tipo_relatorio', e.target.value as TipoRelatorio)}
                    className={painelInputClass}
                >
                    <option value="">Selecione...</option>
                    {TIPOS_RELATORIO.map((tipo) => (
                        <option key={tipo} value={tipo}>{labelTipoRelatorio(tipo)}</option>
                    ))}
                </select>
            ...
            <div>
                ...
                <textarea
                    ...
                    className={painelInputClass}
                />
                {errors.resumo ? <p className="mt-1 text-sm text-red-600">{errors.resumo}</p> : null}
            </div>

            <div>
                <label htmlFor="feedback" className={painelLabelClass}>Feedback (3 pontos)</label>
                <textarea
                    id="feedback"
                    name="feedback"
                    rows={4}
                    ...
                    className={painelInputClass}
                />
                {errors.feedback ? <p className="mt-1 text-sm text-red-600">{errors.feedback}</p> : null}
            </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => onFieldChange('quartos_visitados', e.target.value === '' ? '' : Number(e.target.value))}
                        className={painelInputClass}
                    />
                    {errors.quartos_visitados ? <p className="mt-1 text-sm text-red-600">{errors.quartos_visitados}</p> : null}
                </div>
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => onFieldChange('pessoas_impactadas', e.target.value === '' ? '' : Number(e.target.value))}
                        className={painelInputClass}
                    />
                    {errors.pessoas_impactadas ? <p className="mt-1 text-sm text-red-600">{errors.pessoas_impactadas}</p> : null}
                </div>
            </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    onChange={(e) => onFieldChange('observacao_visitantes_externos', e.target.value)}
                    className={painelInputClass}
                />
                {errors.observacao_visitantes_externos ? <p className="mt-1 text-sm text-red-600">{errors.observacao_visitantes_externos}</p> : null}
            </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    onChange={(e) => onFieldChange('observacoes_gerais', e.target.value)}
                    className={painelInputClass}
                />
                {errors.observacoes_gerais ? <p className="mt-1 text-sm text-red-600">{errors.observacoes_gerais}</p> : null}
            </div>
        </div>
    )
}
