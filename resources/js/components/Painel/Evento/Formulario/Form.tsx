...
interface Props {
    ...
    responsaveis: User[];
    cidades: Cidade[];
    onFieldChange: <K extends keyof EventoFormValues>(
        campo: K,
...
const Form: FC<Props> = ({
    ...
    return (
        <div className="space-y-6">
            <div>
                <label htmlFor="titulo" className={painelLabelClass}>
                    Título *
                </label>
                <input
                    id="titulo"
            ...
            <div>
                ...
                <select
                    ...
                    value={data.tipo}
                    onChange={(e) =>
                        onFieldChange('tipo', e.target.value as EventoTipo)
                    }
                    className={painelInputClass}
                >
            ...
            <div>
                <label htmlFor="descricao" className={painelLabelClass}>
                    Descrição
                </label>
                <textarea
                    id="descricao"
            ...
            <div>
                <label htmlFor="cidade_id" className={painelLabelClass}>
                    Cidade *
                </label>
                <select
                    id="cidade_id"
            ...
            <div>
                <label htmlFor="local" className={painelLabelClass}>
                    Local (complemento)
                </label>
                <input
                    id="local"
            ...
            <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <select
                        ...
                        onChange={(e) =>
                            onFieldChange('hora_inicio', e.target.value)
                        }
                        className={painelInputClass}
                    >
                        <option value="">Selecione...</option>
                    ...
                    {!data.sem_hora_fim && (
                        <>
                            ...
                            <select
                                ...
                                value={data.hora_fim}
                                onChange={(e) =>
                                    onFieldChange('hora_fim', e.target.value)
                                }
                                className={painelInputClass}
                            >
                                <option value="">Selecione...</option>
                                {data.hora_fim &&
                                    !OPCOES_HORARIOS.includes(
                                        data.hora_fim,
                                    ) && (
            ...
            <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    >
                        ...
                        {data.limite_inscricao_hora &&
                            !OPCOES_HORARIOS.includes(
                                data.limite_inscricao_hora,
                            ) && (
                                <option value={data.limite_inscricao_hora}>
                                    {data.limite_inscricao_hora}
                                </option>
                            )}
                        {OPCOES_HORARIOS.map((h) => (
